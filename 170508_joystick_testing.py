...
class TheFrame(wx.Frame):
	def __init__(self, parent, id=wx.ID_ANY, title='',
		...
		self.Bind(wx.EVT_LEFT_DOWN, self.OnUpButtonPress, self.up_button)
		self.Bind(wx.EVT_LEFT_UP, self.OnUpButtonRelease, self.up_button)
		self.Bind(wx.EVT_LEFT_DOWN, self.OnDownButtonPress, self.down_button)
		self.Bind(wx.EVT_LEFT_UP, self.OnDownButtonRelease, self.down_button)
